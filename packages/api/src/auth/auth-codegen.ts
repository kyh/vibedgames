...
export const auth = betterAuth({
  // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: codegen-only stub; the CLI introspects plugins/schema, never opens a real DB connection
