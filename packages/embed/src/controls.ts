 ...
 */
export const activeMethods = (context: ControlContext = {}): ReadonlySet<ControlMethod> => {
 ...
 */
export const watchControlContext = (onChange: () => void): (() => void) => {
  if (typeof window === "undefined") {
    return () => {
      // nothing was subscribed without a window
    };
  }
