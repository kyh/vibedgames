...
/* oxlint-disable jsx-a11y/prefer-tag-over-role, jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- a fieldset's default box model breaks the flex row; the addon click only refocuses the input, which keyboard users reach by Tab */
