...
const NUMS: NumSpec[] = [
  ...
  { key: "steerSpeedFalloff", min: 0.1, max: 1, step: 0.02 },
  { key: "turnRate", min: 1, max: 6, step: 0.1 },
  { key: "turnSpeedFalloff", min: 0.2, max: 1, step: 0.05 },
  { key: "driftTurnBoost", min: 1, max: 3.5, step: 0.1 },
  { key: "yawAssist", min: 1, max: 20, step: 0.5 },
  { key: "gripNormal", min: 0, max: 14, step: 0.5 },
  { key: "gripDrift", min: 0, max: 8, step: 0.1 },
  { key: "brakeForce", min: 500, max: 12000, step: 100 },
  { key: "handbrakeForce", min: 500, max: 9000, step: 100 },
  { key: "handbrakeGrip", min: 0.05, max: 1, step: 0.01 },
