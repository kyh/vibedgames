...
const STOPS: readonly Stop[] = [
  ...
  stop(0.00,  35,   115,   dir(35, 115),  0xfff6e0, 1.9,  0xbfe0ff, 0x4a4a3e, 0.35, 0.08, 0xbcd7ea, 420, 960, 0.32, 0,    0.62),
  stop(0.25,  50,   150,   dir(50, 150),  0xfff2d8, 2.0,  0xbfe0ff, 0x4a4a3e, 0.35, 0.08, 0xbcd7ea, 420, 960, 0.32, 0,    0.62),
  stop(0.40,  12,   235,   dir(12, 235),  0xffc27a, 1.8,  0xffd9b0, 0x57503e, 0.30, 0.09, 0xe3c19b, 380, 900, 0.26, 0.25, 0.68),
  stop(0.47,   2,   248,   dir(4, 248),   0xff9350, 1.25, 0xff9d70, 0x3e3a44, 0.28, 0.10, 0xcf9077, 340, 820, 0.18, 0.7,  0.70),
