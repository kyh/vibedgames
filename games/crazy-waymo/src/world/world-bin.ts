...
export const WORLD_REV = 42; // bump when generation code changes → rebake (42 = class-scaled sidewalks — minor streets stop merging into asphalt lakes on the hill grid)
