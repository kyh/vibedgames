...
export const WORLD_REV = 51; // bump when generation code changes → rebake (51 = parcel-fit polish: 4u height floor, per-segment occupancy so rows infill around parcels)
