...
export const WORLD_REV = 53; // bump when generation code changes → rebake (53 = road variety pass: per-street paint schemes, control-matched crosswalks, crack-free drape, parking ticks)
