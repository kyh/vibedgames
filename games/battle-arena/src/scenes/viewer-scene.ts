...
const CREEPS: RosterEntry[] = [
  { id: "skwarrior", label: "Skeleton Warrior", sub: "camp creep", kind: "creep", model: "Skeleton_Warrior", weaponR: "Skeleton_Blade", attackClips: ["Melee_2H_Attack_Chop", "Melee_2H_Attack_Slice", "Melee_2H_Attack_Stab"] },
  ...
  { id: "skminion", label: "Skeleton Minion", sub: "camp creep", kind: "creep", model: "Skeleton_Minion", weaponR: "Skeleton_Axe", attackClips: ["Melee_2H_Attack_Chop", "Melee_2H_Attack_Stab"] },
  { id: "skrogue", label: "Skeleton Rogue", sub: "camp creep", kind: "creep", model: "Skeleton_Rogue", weaponR: "Skeleton_Axe", attackClips: ["Melee_2H_Attack_Slice", "Melee_2H_Attack_Spin", "Melee_2H_Attack_Chop"] },
