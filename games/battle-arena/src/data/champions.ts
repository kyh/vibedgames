...
export const CHAMPIONS: ChampDef[] = [
  {
    ...
    abilities: {
      ...
      E: ab({
        ...
        values: { shield: [120, 200, 280, 360], duration: [4, 4, 4, 4], speed: [16, 18, 20, 22] },
  ...
  },
  {
    ...
    abilities: {
      Q: ab({
        ...
        values: { damage: [65, 90, 115, 135], arrows: [3, 3, 5, 5], spread: [22, 22, 26, 26] },
  ...
  },
  {
    ...
    abilities: {
      Q: ab({
        ...
        values: { damage: [150, 200, 250, 300], radius: [2.6, 2.8, 3.0, 3.2] },
  ...
  },
  {
    ...
    abilities: {
      ...
      E: ab({
        ...
        manaCost: [0, 0, 0, 0],
        cooldown: [16, 15, 14, 13],
        values: { armor: [8, 12, 16, 20], hps: [30, 45, 60, 75], duration: [4, 4, 4, 4] },
      ...
      JUMP: ab({
        ...
        cooldown: [9],
        maxRank: 1,
        values: { base: [100], perLevel: [9], radius: [3.0], stun: [0.4] },
