...
export const CHAMPIONS: ChampDef[] = [
  {
    ...
    abilities: {
      Q: ab({ key: "Q", name: "Cleaving Blow", effect: "knight:Q", targeting: "direction", castRange: 3.6, manaCost: [0, 0, 0, 0], cooldown: [8, 7.5, 7, 6.5], values: { damage: [70, 110, 150, 190], stun: [0.7, 0.9, 1.05, 1.2], cone: [90, 90, 90, 90] }, desc: "A sweeping two-handed arc — damage and stun everyone in front." }),
      W: ab({ key: "W", name: "Seismic Slam", effect: "knight:W", targeting: "direction", castRange: 7, manaCost: [0, 0, 0, 0], cooldown: [10, 9.5, 9, 8.5], values: { damage: [55, 85, 115, 145], slow: [25, 25, 30, 30], slowDur: [1, 1, 1.25, 1.25], width: [2, 2, 2, 2] }, desc: "Slam a fissure forward, damaging and slowing a line of enemies." }),
  ...
  },
  {
    ...
    abilities: {
      Q: ab({ key: "Q", name: "Multishot", effect: "ranger:Q", targeting: "direction", castRange: 10, manaCost: [0, 0, 0, 0], cooldown: [6, 5.5, 5, 4.5], values: { damage: [55, 85, 115, 145], arrows: [3, 3, 5, 5], spread: [22, 22, 26, 26] }, desc: "Loose a fan of arrows." }),
  ...
  },
  {
    ...
    abilities: {
      Q: ab({ key: "Q", name: "Fireball", effect: "mage:Q", targeting: "direction", castRange: 11, manaCost: [0, 0, 0, 0], cooldown: [5, 4.6, 4.2, 3.8], values: { damage: [80, 130, 180, 230], radius: [2.6, 2.8, 3.0, 3.2] }, desc: "Hurl a fireball that bursts on impact." }),
      W: ab({ key: "W", name: "Frost Nova", effect: "mage:W", targeting: "ground", castRange: 9, manaCost: [0, 0, 0, 0], cooldown: [10, 9, 8, 7], values: { damage: [60, 95, 130, 165], slow: [35, 40, 45, 50], slowDur: [2, 2.2, 2.4, 2.6], radius: [3.2, 3.4, 3.6, 3.8] }, desc: "Detonate a ring of frost — damage and heavy slow." }),
  ...
  },
  {
    ...
    abilities: {
      Q: ab({ key: "Q", name: "Poison Lunge", effect: "rogue:Q", targeting: "direction", castRange: 4.5, manaCost: [0, 0, 0, 0], cooldown: [7, 6.5, 6, 5.5], values: { damage: [50, 80, 110, 140], dps: [30, 45, 60, 75], dur: [4, 4, 4, 4], speed: [22, 22, 22, 22] }, desc: "Lunge and coat the target in poison." }),
      W: ab({ key: "W", name: "Rupture", effect: "rogue:W", targeting: "direction", castRange: 7, manaCost: [0, 0, 0, 0], cooldown: [9, 8.5, 8, 7.5], values: { damage: [45, 70, 95, 120], dmgAmp: [12, 15, 18, 21], ampDur: [3, 3, 3.5, 3.5], bleedDps: [20, 30, 40, 50], bleedDur: [3, 3, 3, 3] }, desc: "Open a bleeding wound — the target bleeds and takes more damage." }),
  ...
  },
  {
    ...
    abilities: {
      Q: ab({ key: "Q", name: "Executioner's Arc", effect: "blackknight:Q", targeting: "direction", castRange: 3.8, manaCost: [0, 0, 0, 0], cooldown: [6, 5.5, 5, 4.5], values: { damage: [85, 130, 175, 220], cone: [110, 110, 110, 110], slow: [20, 20, 20, 20], slowDur: [1, 1, 1, 1] }, desc: "A vast sweeping cut — carve and slow everyone in front." }),
      W: ab({ key: "W", name: "Consecrating Smite", effect: "blackknight:W", targeting: "ground", castRange: 8, manaCost: [0, 0, 0, 0], cooldown: [11, 10.5, 10, 9.5], values: { damage: [70, 105, 140, 175], stun: [0.5, 0.6, 0.7, 0.8], radius: [2.4, 2.6, 2.8, 3.0] }, desc: "Call down a pillar of holy light — damage and stun where it lands." }),
  ...
  },
  {
    ...
    abilities: {
      Q: ab({ key: "Q", name: "Hex Bolt", effect: "witch:Q", targeting: "direction", castRange: 9, manaCost: [0, 0, 0, 0], cooldown: [7, 6.5, 6, 5.5], values: { damage: [70, 110, 150, 190], slow: [20, 25, 30, 35], slowDur: [1.2, 1.2, 1.2, 1.2], speed: [18, 18, 18, 18] }, desc: "Spit a curdled bolt — damage and slow whoever it strikes." }),
      W: ab({ key: "W", name: "Cauldron Brew", effect: "witch:W", targeting: "ground", castRange: 8, manaCost: [0, 0, 0, 0], cooldown: [13, 12, 11, 10], values: { dps: [45, 70, 95, 120], slow: [25, 30, 35, 40], radius: [3.2, 3.4, 3.6, 3.8], duration: [4, 4, 4, 4] }, desc: "Spill the cauldron — the brew burns and slows all who wade in." }),
