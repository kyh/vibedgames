...
export const ITEMS: ItemDef[] = [
  ...
  },
  {
    ...
    cost: 1300,
    icon: "item-vampiric",
    stats: { lifesteal: 0.15, damage: 12 },
  ...
  },
  {
    ...
    cost: 1700,
    icon: "item-arcaneorb",
    stats: { abilityPower: 0.3, hp: 180, damage: 10 },
  ...
  },
  {
    ...
    cost: 1700,
    icon: "item-reaver",
    stats: { damage: 38, attackSpeed: 15 },
  ...
  },
  {
    ...
    icon: "item-elixir",
    stats: { hpRegen: 4 },
    active: { kind: "heal", cooldown: 35, amount: 320, desc: "Heal 320 HP." },
  ...
  },
  {
    ...
    active: { kind: "cleanse", cooldown: 24, desc: "Clear disables." },
  ...
  },
  {
    ...
    stats: { moveSpeed: 1.3, attackSpeed: 18 },
    active: { kind: "haste", cooldown: 30, amount: 40, desc: "+40% move speed, 3s." },
  ...
  },
  {
    ...
    cost: 1500,
    icon: "item-bulwark",
    stats: { hp: 320, armor: 5 },
    active: { kind: "shield", cooldown: 45, amount: 350, desc: "Shield 350, 4s." },
  ...
  },
  {
    ...
    cost: 1600,
    icon: "item-phaseband",
    stats: { moveSpeed: 0.6, hp: 180 },
    active: { kind: "blink", cooldown: 14, range: 9, desc: "Blink 9 units." },
