...
const canvasRect = (scene: Phaser.Scene): CanvasRect => {
...
export const gameInset = (scene: Phaser.Scene): GameInset => {
...
export const touchHudBand = (scene: Phaser.Scene): number => {
  if (!isCoarse()) {
    return 0;
  }
