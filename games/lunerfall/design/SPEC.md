...
- **The twist:** TowerFall is a single-arena PvP deathmatch; we keep its *feel*
...
(Online *versus* explicitly out — our last-write-wins stack fights competitive
...
rest, boss); **1–2 heroes** feeling *great*; 4 minions; Salamander boss; hearts;
...
Ship a solo slice that *feels* like TowerFall before adding netcode.
