...
export function valAt(v: AbilityValue | undefined, rank: number): number {
  ...
  if (v === undefined || v === false || v === true) return 0;
  return v;
}
...
export const HEROES: HeroDef[] = [
  {
    ...
    abilities: {
      ...
      E: ab({
        ...
        cooldown: [0],
        castRange: 0,
        values: { auraRadius: 600, moveSpeedPct: [4, 6, 8, 10], hpRegen: [2, 3.5, 5, 6.5] },
      }),
      R: ab({
        key: "R",
        name: "Unbreaking Vow",
  ...
  },
  {
    ...
    abilities: {
      Q: ab({
        ...
        castRange: 800,
        values: { damage: [90, 140, 190, 240], length: 800, width: 90, falloffPct: 12, minPct: 50 },
      }),
      W: ab({
        key: "W",
        name: "Hunter's Mark",
  ...
  },
  {
    ...
    abilities: {
      Q: ab({
        ...
        castRange: 550,
        values: { damage: [90, 150, 210, 270], radius: 180, projectileSpeed: 700 },
      }),
      W: ab({
        key: "W",
        name: "Cinder Trail",
      ...
      E: ab({
        ...
        castRange: 0,
        values: { dps: [25, 40, 55, 70], radius: 200, spellAmpPct: [8, 12, 16, 20], duration: 5 },
      }),
      R: ab({
        key: "R",
        name: "Conflagration",
  ...
  },
  {
    ...
    abilities: {
      Q: ab({
        ...
        cooldown: [8, 7.5, 7, 6.5],
        castRange: 550,
        values: { heal: [80, 130, 180, 230], regenPerSec: [10, 15, 20, 25], regenDuration: 4 },
      }),
      W: ab({
        key: "W",
        name: "Hex Bottle",
