...
//
// Sibling copies (pacman/tetris) share this structure; only the tuning
// constants and the unit of `rot` (degrees here for 2D Phaser setAngle,
// radians for the 3D games) legitimately differ. Keep the shape identical
...
const MAX_OFFSET = 14;
/** Max camera rotation at trauma=1, degrees. */
const MAX_ROT = 5;
...
/** Frame sample: positional offset (px) + rotation (degrees, for setAngle). */
