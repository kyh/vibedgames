...
export const docsDoc: Doc = {
  description:
    "Developer documentation for Vibedgames: the vg CLI, the oRPC API, authentication, the multiplayer and gamepad packages, and the machine-readable endpoints an agent can fetch.",
  lead: [
    {
      kind: "p",
