...
// polls it in a loop, better-auth's rate limiter (10 req/60s), and requests
// the transport plugins turn away (header-less CSRF probes, GETs on POST-only
// procedures, oversized bodies). Observability is enabled on this Worker, so
