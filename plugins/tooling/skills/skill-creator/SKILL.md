...
```bash
scripts/init_skill.mjs <skill-name> --path <output-directory>
```
...
```bash
scripts/analyze_skill.mjs <path/to/skill>
```
...
```bash
scripts/upgrade_skill.mjs <path/to/skill>
```
...
```bash
scripts/package_skill.mjs <path/to/skill>
```
...
```bash
node scripts/analyze_skill.mjs <path/to/skill>
```
...
```bash
node scripts/upgrade_skill.mjs <path/to/skill>
```
...
```bash
node scripts/quick_validate.mjs
```
