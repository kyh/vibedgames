...
description: >
  ...
  VFX derived from a generated video rendered with additive blend. Routing: asset phase; runs through `generate`; then `animation` to refine frames, `phaser` to wire them in; clean fakes with `pixel-snapper`.
metadata:
  author: vibedgames
  version: "0.1.0"
---
