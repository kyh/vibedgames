...
For prompt mechanics specific to GPT Image 2, see [model-prompting/references/gpt-image-2.md](../../model-prompting/references/gpt-image-2.md).
...
```bash
vg generate run openai/gpt-image-2/edit \
  --image_urls "$URL_REF" \
...
- Endpoint selection: [model-catalog/text-to-image.md](../../model-catalog/references/text-to-image.md), [image-to-image.md](../../model-catalog/references/image-to-image.md).
- Prompt mechanics for the dominant family: [model-prompting/references/gpt-image-2.md](../../model-prompting/references/gpt-image-2.md).
