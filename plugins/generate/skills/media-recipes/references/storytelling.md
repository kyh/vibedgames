...
Use this recipe when the user wants a sequence, not a single asset. The goal is clear story beats and executable vg generate runs. Avoid generic inspiration copy, fake dialogue, and em dashes.
...
1. Routed endpoints (see [model-catalog/text-to-video](../../model-catalog/references/text-to-video.md) and [image-to-video](../../model-catalog/references/image-to-video.md)):
