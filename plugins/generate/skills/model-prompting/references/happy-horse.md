...
Alibaba's text-to-video model. Translates short, declarative text directions into video, particularly strong with camera moves and atmospheric lighting.
...
Run `vg generate schema alibaba/happy-horse/text-to-video --json` for authoritative list. Typical:
