...
OpenAI's image model. Excels at detailed images with fine typography. Three modes: text-to-image, edit, and multi-image compositing.
...
GPT Image 2 is the strongest endpoint for accurate readable text inside generated images. To get clean typography:
...
Run `vg generate schema openai/gpt-image-2 --json` for authoritative list. Typical:
