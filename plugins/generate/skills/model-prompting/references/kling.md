...
Kling is Kuaishou's video model family. Two generations are routinely useful:
...
Run `vg generate schema <endpoint_id> --json` for the authoritative list. Frequently exposed:
