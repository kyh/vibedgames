...
name: media-workflow
description: >
  Design and execute multi-step media workflows with `vg media`. Use this for
...
2. Resolve endpoints for each role. Check known endpoint IDs first.
   ...
   vg media models --endpoint_id nano-banana-pro/edit --json
   ...
   vg media docs "workflow utility endpoints" --json
   ```
