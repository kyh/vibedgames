...
RES1=$(vg media run nafnet/denoise --image_url "$URL1" --json)
...
```bash
vg media schema nafnet/deblur --json
vg media schema codeformer --json
vg media schema docres --json
```
