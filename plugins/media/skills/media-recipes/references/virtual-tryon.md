...
```bash
vg media schema fashn/tryon/v1.5 --json
```
...
vg media models --endpoint_id bria/background/remove --json
```
...
RES_TRYON=$(vg media run fashn/tryon/v1.5 \
 --model_image "$URL_PERSON" \
