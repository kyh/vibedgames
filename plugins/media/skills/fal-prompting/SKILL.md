...
4. **Inspect schema before assuming a control exists.** `vg media schema <endpoint_id> --json`. Negative prompt, seed, multi-prompt, and reference-image fields differ across families.
