...
from _fal_common import build_unit_price_estimate_payload, platform_get, platform_post, require_fal_key


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Query fal platform APIs for models, pricing, usage, and request audit.")
...
def main() -> None:
    ...
    if args.command == "search":
        ...
        for endpoint_id in args.endpoint_id:
            endpoints[endpoint_id] = {"unit_quantity": args.unit_quantity}
